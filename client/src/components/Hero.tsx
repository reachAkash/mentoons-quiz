...
const Section1 = () => {
  return (
    <motion.div className="relative bg-[#EC9600] h-fit py-7">
      ...
      <div className="border-[5px] flex relative bottom-6 border-purple-800 lg:h-fit overflow-hidden">
        <img
          className="absolute cursor-pointer hover:scale-105 transition-all duration-300 ease-in-out top-absolute left-0 w-[22rem]"
          src={bottleImg}
          alt="quiz image"
        />
        <img
          className="absolute  cursor-pointer hover:scale-105 transition-all duration-300 ease-in-out bottom-[-8rem] left-[-8rem] w-[35rem] rotate-[35deg]"
          src={geometryImg}
          alt="quiz image"
        />
        <img
          className="absolute  cursor-pointer hover:scale-105 transition-all duration-300 ease-in-out bottom-0 left-[8rem] w-[34rem] z-10"
          src={steplarImg}
          alt="quiz image"
        />
        <img
...
const Section2 = () => {
  return (
    <motion.div className="container relative flex flex-col items-start md:flex-row bg-gray-50 lg:px-[10rem] h-[90vh]">
      <div className="flex flex-col justify-around h-full w-full">
        ...
        <div className="text-red-500 purple-text-shadow font-bold text-[1.5rem] lg:text-[2rem]">
          Have you ever wondered <WordBreak /> who invented all the cool stuff{" "}
          <WordBreak /> you use everyday{" "}
        </div>
        <div className="text-[#414068] red-text-shadow font-extrabold text-[1.5rem] lg:text-[2rem]">
      ...
      <div className="w-full flex flex-col justify-center items-end gap-2 ">
        <div className="w-full flex items-start justify-end">
          <img className="scale-125" src={questionMark} />
        </div>
        <div className="absolute z-10 bottom-0 right-0 bg-[#d12881] space-y-3 py-6 px-3 w-[24rem] h-[15rem] text-white font-semibold text-xl">
        ...
        <div className=" w-[384px] h-[210px] absolute bottom-0 px-6 py-3 right-2 bg-black"></div>
      </div>
    </motion.div>
  );
};
...
const Section3 = () => {
  return (
    <div className="container py-8 space-y-1 bg-orange-500 h-fit">
      <div className="relative">
        <div className="angled-container absolute top-0 left-[40%] w-[20rem] h-[8rem] px-6 py-3 rounded-full z-40 bg-[#d12881]">
          <div className="text">Guess What</div>
        </div>
        <div className="angled-container relative left-[41%] w-[20rem] h-[8rem] px-6 py-3 rounded-full bg-black"></div>
      </div>
      ...
      <div className="flex relative items-center justify-between">
        <div className="flex w-1/2">
          <img
            className="absolute cursor-pointer hover:scale-105 hover:z-10 left-[11rem] top-0"
            src={choosewislyImg}
            alt="books image"
          />
          <img
            className="absolute cursor-pointer hover:scale-105 hover:z-10 left-[8rem] top-0"
            src={hungryforlikesImg}
            alt="books image"
          />
          <img
            className="absolute cursor-pointer hover:scale-105 hover:z-10 left-8 top-0"
            src={dontfadeImg}
            alt="books image"
          />
        </div>
      ...
      <div className="bg-red-500 py-4 cursor-pointer hover:text-red-500 hover:bg-white transition-all ease-in-out duration-500  text-white font-semibold text-2xl text-center">
        Take me to Quiz
      </div>
    </div>
  );
